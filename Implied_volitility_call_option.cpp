//
//  CODE to find implied Volatility for CALL option.
...
int main() {
    ...
    double K = 45; // strike price
    double C = 6.5; // put price
    double q = 0.01; // dividends
    ...
    double x_0 = 0.25; // sigma, volitility initial guess
        ...
        
    {
        ...
        x_old = x_new;
        x_new = x_new - ((call_price_norm(t,S,K,T,x_new,q,r) - C) / vega_call(t,S,K,T,x_new,q,r));
    }
